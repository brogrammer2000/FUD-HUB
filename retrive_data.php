...
<head>
    ...
    <!--CSS link-->
    <link rel="stylesheet" href="frontpage_afterLogin.css">
...
<body>
    <div class = "container">
       ...
       <div class="row navBar">       
        ...
        <div class = "row">
            <div class = "col-lg-12">
                 <img class = "main_img" src="bm_img2.jpg" alt = "couple-cooking" class = "img-fluid">
            </div>
        ...
        <div class = "row" style="margin-top: 30px">
            <div class = "col-lg-12" >
            <h1 id="heading" style="color: white;">I'm a foodie looking for a recipe for:</h1>
            </div>  <!-- col -->  
        </div>  <!-- row -->
    
        <div class = "row">
          <div class = "col-lg-4">
                 <img class="option" src="breakfast.jpg" alt="breakfast" class="img-fluid">           
                <a href="breakfast.html" class="breakfast">                
                <h3>BREAKFAST</h3>
                 </a>
            </div>  <!-- col -->   
            
            <div class = "col-lg-4">
                 <img class="option" src="lunch1.jpg" alt="lunch" class="img-fluid">           
             ...
             <div class = "col-lg-4">
                 <img class="option" src="dinner2.jpg" alt="dinner" class="img-fluid">           
